...
make_naive_Bayes_naivebayes <- function() {
  ...
  parsnip::set_dependency("naive_Bayes",
                          eng = "naivebayes",
                          pkg = "naivebayes",
                          mode = "classification")
  parsnip::set_dependency("naive_Bayes",
...
make_naive_Bayes_klaR <- function() {
  ...
  parsnip::set_dependency("naive_Bayes", "klaR", "klaR", "classification")
  parsnip::set_dependency("naive_Bayes", "klaR", "discrim", "classification")
